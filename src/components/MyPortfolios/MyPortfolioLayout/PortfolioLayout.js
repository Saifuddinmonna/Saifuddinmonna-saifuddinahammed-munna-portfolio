								...
								{datas?.map((p, ind) => (
									...
									>
										...
										>
											...
											<motion.span className="text-indigo-600 dark:text-indigo-300" whileHover={{ color: "#EC4899" }} transition={{duration: 0.2}}>
												{" "}Founded{" "}
												{datas.length === 14 ? "Here " : "in This Category"}
											</motion.span>
										</motion.h1>
										<section className="text-gray-600 dark:text-gray-200 body-font">
											<div className="container p-3 m-3 mx-auto">
												...
												>
													{p.category} :{" "}
													<motion.span className="text-indigo-600 dark:text-indigo-300" whileHover={{ letterSpacing: "0.5px", color: "#EC4899" }} transition={{duration: 0.2}}>
														{p.name}
													</motion.span>
												</motion.h1>
