...
const MyportfolioImage = () => {
	const [portfilios, setPortfilios] = useState(portfolios);
	const [portfilio, setPortfilio] = useState();

	console.log(portfolios);
	useEffect(() => {
		portfolios.map((portfolio) => {
			setPortfilio(portfolio);
			console.log(portfolio.name);
			portfolio.image.map(images=>{console.log(images)});
