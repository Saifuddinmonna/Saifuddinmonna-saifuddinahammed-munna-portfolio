...
const GalleryItem = ({ image, onClick, viewMode = "grid-3" }) => {
    ...
    return (
      <div className="flex flex-col md:flex-row gap-4 w-full">
        ...
        <div className="md:w-1/3">
          <div
            className="relative cursor-pointer overflow-hidden rounded-lg shadow-lg hover:shadow-xl transition-all duration-500 ease-in-out aspect-[4/3]"
