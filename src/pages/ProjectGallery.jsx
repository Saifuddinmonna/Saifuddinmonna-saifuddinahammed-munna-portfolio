...
import NavbarPage2 from "../components/layout/NavbarPage/NavbarPage2";
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white dark:bg-gray-900">
      ...
      <div className="container mx-auto px-4 py-8 mt-14">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300">
                - Place your project screenshots in the{" "}
                <code className="bg-gray-200 dark:bg-gray-700 px-2 py-1 rounded">
                  public/images/projects/
                </code>{" "}
                folder - Use high-quality images (recommended size: 1200x900 pixels) - Name your
                images descriptively (e.g., project1.jpg, project2.jpg)
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300">
                For each project, provide: - Title: Your project name - Description: Brief overview
                of the project - Live Website URL: Where users can see the project - GitHub
                Repository: Link to your source code - Technology Stack: List of technologies used
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300">
                - Click on any project to view it in full size - Hover over projects to see details
                - Click the "Live Website" link to visit the project - Click the GitHub icon to view
                the source code
              </p>
            </div>
          </div>
        ...
        {/* Gallery Grid */}
        <GalleryGrid images={projects} onImageClick={setSelectedImage} />
